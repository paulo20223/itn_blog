            ...
            CKEDITOR.dialog.add('youtube', function (instance) {
                ...
                return {
                                        ...
                                        children:
                                            [
                                                ...
                                                },
                                                {
                                                    ...
                                                    'default': editor.config.youtube_width != null ? editor.config.youtube_width : 'auto',
                                                    validate: function () {
                                                        // if (this.getValue()) {
                                                ...
                                                },
                                                {
                                                    ...
                                                    'default': editor.config.youtube_height != null ? editor.config.youtube_height : 'auto',
                                                    validate: function () {
                                                        // if (this.getValue()) {
                    ...
                    onOk: function () {
                        ...
                        content = '<div class="video-container">' + content + '</div>';
